...
\begin{itemize}
    \item \textbf{Speech Act:} A linguistic act where ``saying so makes it so.''
    \item The utterance itself performs an action rather than just describing the world.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Games (Baseball):}
          \begin{itemize}
              \item Umpire: ``You ain't nothing till I say so.''
              \item The calls (strike, ball, out) become facts within the game \textit{because} the umpire declares them.
          \end{itemize}
    \item \textbf{Ceremonies (Marriage):}
          \begin{itemize}
              \item Officiant: ``I now pronounce you husband and wife.''
              \item The utterance changes the legal, religious, and personal status of the couple.
          \end{itemize}
\end{itemize}

\subsection{The Thereby Test}
A method to identify speech acts.
\begin{itemize}
    \item \textbf{Pattern:} If I say, ``I [verb],'' then I \textit{thereby} [verb].
    \item \textbf{Rule:} If the sentence makes sense with this pattern, the verb names a speech act.
    \item \textbf{Examples:}
          \begin{itemize}
              \item ``I promise...'' $\rightarrow$ I thereby promise. (Valid)
              \item ``I apologize...'' $\rightarrow$ I thereby apologize. (Valid)
              \item ``I thank you...'' $\rightarrow$ I thereby thank you. (Valid)
          \end{itemize}
    \item \textbf{Contrast:} ``I walk'' $\rightarrow$ ``I thereby walk'' (Invalid -- distinguishing description from action).
\end{itemize}

\subsection{Conditions}
Speech acts function only under \textbf{appropriate circumstances}.
\begin{itemize}
    \item \textbf{Authority/Context:} You cannot declare strangers married on the street. You must be an officiant in a ceremony.
    \item \textbf{Receiver's Attitude (Uptake):}
          \begin{itemize}
              \item \textit{Promise vs. Threat:} Depends on whether the receiver \textit{wants} the action to happen.
          \end{itemize}
    \item \textbf{Failure:} If circumstances are wrong (e.g., the other person refuses a bet), the speech act may fail or become a different act.
\end{itemize}

\subsection{Argumentation as a Speech Act}
\begin{itemize}
    \item \textbf{Arguing} is a speech act.
    \item It involves using language to \textbf{justify} or \textbf{explain} a conclusion.
    \item Understanding speech acts provides the context for understanding arguments.
\end{itemize}
